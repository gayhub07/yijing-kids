<script lang="ts">
  ...
  import { updateBaguaProgress, getBaguaProgress } from '$lib/supabase/api'
  
  // 八卦完整数据
  const baguaData: Record<string, {
    name: string
    symbol: string
    nature: string
    element: string
    ...
    '乾': {
      ...
      element: '金',
      meaning: '刚健、创造、自强不息',
      story: '在很久很久以前，有一条小龙生活在深山里。它每天都努力练习飞翔，想要飞到最高的天空。虽然有时候会摔倒，但它从不放弃。终于有一天，它飞上了云端，成为了天空之王！这就是乾卦告诉我们的道理：要像天一样刚强，永不放弃，就一定能成功！',
      traits: ['勇敢', '坚强', '有志气', '主动'],
      emoji: '🐉'
    },
    '坤': {
      ...
      element: '土',
      meaning: '柔顺、承载、厚德载物',
      story: '大地妈妈很温柔，她抱着所有的花草树木，让它们在自己的怀抱里长大。不管是高高的大树，还是小小的花朵，大地妈妈都会给它们营养和水分。坤卦告诉我们，要像大地一样，温柔地对待别人，帮助身边的人成长。',
      traits: ['温柔', '包容', '稳重', '善良'],
      emoji: '🌍'
    },
    '震': {
      ...
      element: '木',
      meaning: '震动、启动、惊醒万物',
      story: '春天来了，轰隆隆的雷声唤醒了沉睡的小种子。"该起床啦！"雷公公喊道。小种子们伸伸懒腰，从泥土里探出头来，开始新的生活。震卦告诉我们，有时候需要一点"惊吓"来开始新的事情，不要害怕变化哦！',
      traits: ['活力', '积极', '勇敢', '有冲劲'],
      emoji: '⚡'
    },
    '巽': {
      ...
      element: '木',
      meaning: '渗透、顺从、温柔入微',
      story: '春风姑娘很温柔，她轻轻地吹过田野，吹过森林，吹过每一个角落。她不强迫任何人，但每个人都能感受到她的存在。小树苗在她的抚摸下慢慢长高，花儿在她的陪伴下绽放。巽卦告诉我们，温柔的力量也很强大！',
    ...
    '坎': {
      ...
      element: '水',
      meaning: '险陷、流动、以柔克刚',
      story: '小溪流遇到了一块大石头，挡住了去路。它没有硬冲，而是轻轻地绕过去，继续向前流淌。久而久之，石头被水冲出了一个小洞，小溪顺利通过了！坎卦告诉我们，遇到困难不要怕，像水一样灵活，总能找到办法。',
    ...
    '离': {
      ...
      element: '火',
      meaning: '光明、依附、热情灿烂',
      story: '太阳公公每天都准时起床，把温暖和光明送给大地。有了阳光，花儿才能开放，小动物才能快乐地玩耍。离卦就像太阳一样，告诉我们要把快乐和温暖分享给身边的人，让大家都能感受到光明！',
    ...
    '艮': {
      ...
      element: '土',
      meaning: '静止、稳定、适可而止',
      story: '高山爷爷站得很稳，不管是刮风还是下雨，他都一动不动。小动物们都知道，遇到危险可以躲到山后面。艮卦告诉我们，有时候要懂得停下来，不要太着急，稳稳当当才能走得远。',
    ...
    '兑': {
      ...
      element: '金',
      meaning: '喜悦、沟通、口才伶俐',
      story: '小湖边总是很热闹，小鸭子在游泳，青蛙在唱歌，小朋友们也在开心地玩耍。大家聚在一起，说说笑笑，多么快乐啊！兑卦告诉我们，和朋友聊天、分享快乐是一件很美好的事情！',
